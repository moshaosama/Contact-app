...
public class ContactController {
    ...
    @CrossOrigin(origins = "*")
    @PutMapping("/EditContact/{contact_id}")
    public Contact editContactById(@PathVariable("contact_id") Integer id,
            @RequestBody Contact contact) {
        return this.ContactService.editContactById(id, contact);
    }
}